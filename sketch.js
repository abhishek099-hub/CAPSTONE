...
function setup() 
{
 ...
 // bk_song.setVolume(0.5);
  ...
  button.mouseClicked(drop);
   ...
   button2.position(375,90);
   button2.size(50,50);
   button2.mouseClicked(drop2);

   blower = createImg("baloon2.png");
   blower.position(280,350)
   blower.size(120,120)
   blower.mouseClicked(blower_F);
  ...
  star = createSprite(300,50,50,20);
  star.addImage("star",star_Img);
  star.scale = 0.02;
  star2 = createSprite(90,370);
  star2.addImage("star",star_Img)
  star2.scale = 0.02;

 display_star = createSprite(50,20)
 display_star.addAnimation("Empty",Emptystar);
  display_star.addAnimation("one",one_star);
  display_star.addAnimation("2",stars);
...
function draw() 
{
  ...
  if(collide(fruit,star2,20)==true){
    star2.visible = false;
    display_star.changeAnimation("2")
  }
